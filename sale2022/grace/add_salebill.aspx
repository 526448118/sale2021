        ...
        <table border="0"  width="866">            
            ...
            <tr>
                <td class="auto-style43">
                    ...
                    中 心：</td>
                <td class="auto-style43">
                    <asp:DropDownList ID="DropDownList1" runat="server" Height="18px" Width="95%">
            ...
            <tr>
                <td class="auto-style43">产品名称：<asp:TextBox ID="pluname0" runat="server" BackColor="#00FF99" BorderColor="#660033" BorderStyle="Double" BorderWidth="1px" Height="24px"  AutoPostBack ="True" Width="48px" OnTextChanged="pluname0_TextChanged"></asp:TextBox>
                </td>
            ...
            <tr>
                <td class="auto-style32" rowspan="2">开票商品规格型号：</td>
                ...
                <td class="auto-style19" colspan="2" rowspan="2">开票商品单位：</td>
                <td class="auto-style41" colspan="2" rowspan="2">
