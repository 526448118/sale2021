...
<body>
    ...
    <div class="rightinfo">
                ...
                单据状态：<asp:DropDownList ID="DropDownList1" runat="server" class="easyui-combobox" name="state"  labelPosition="top"  Height="30px" Width="110px">
                ...
                单据来源：<asp:DropDownList ID="DropDownList2" runat="server" class="easyui-combobox" name="state"  labelPosition="top"  Height="30px" Width="110px">
                ...
                部门筛选：<asp:DropdownList id="dr1" runat="server" AutoPostBack="True" class="easyui-combobox" name="state"  labelPosition="top" OnSelectedIndexChanged="dr1_SelectedIndexChanged" Width="90px" Height="30px">
                ...
                单据号：<asp:TextBox ID="num" runat="server" Width="100" CssClass="scinput" ></asp:TextBox>
                客户名称：<asp:TextBox ID="custname" runat="server" Width="100" CssClass="scinput"></asp:TextBox>              
                <br />
                业务员：<asp:TextBox ID="ywy" runat="server" Width="100" CssClass="scinput"></asp:TextBox>
                订单金额：<asp:TextBox ID="jine1" runat="server" Width="100" TextMode="Number" CssClass="scinput"></asp:TextBox>
                至<asp:TextBox ID="jine2" runat="server" Width="100" TextMode="Number" CssClass="scinput"></asp:TextBox>
            ...
            <!--列表-->
<asp:Repeater ID="rptList" runat="server" OnItemDataBound="rptList_ItemDataBound" EnableTheming="True">
<HeaderTemplate>
