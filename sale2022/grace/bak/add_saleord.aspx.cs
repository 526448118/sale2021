              ...
              SqlTransaction tran = con.BeginTransaction();
                 ...
                 try
                 {
                     ...
                     for (int i = 0; i < GridView1.Rows.Count; i++)
                     {
                         ...
                         sqlStr = "INSERT INTO ord_plu(saleno,ID,plucode,pluname,price,count,unit,ystotal,zk,sstotal) "
      + " VALUES('" + saleno + "','" + id + "','" + plucode1 + "','" + pluname1 + "','" + price1 + "','" + count1 + "','" + unit1 + "','" + ystotal1 + "','" + zk1 + "','" + sstotal1 + "')";
