...
<HeaderTemplate>
	  <table class="tablelist">
    	...
    	<tr>
             ...
             <th width="20px;">中心</th>
             <th width="80px;">部门</th>
             <th width="40px;">销售员</th>
             <th width="20px;">销售员电话</th>
             <th width="80px;">录入日期</th>
             <th width="80px;">提货日期</th>
             <th width="80px;">订单来源</th>
             <th width="20px;">提货方式</th>
             <th width="20px;">商品类型</th>
             <th width="20px;">客户名称</th>
             <th width="20px;">联系人</th>
             <th width="20px;">客户电话</th>
             <th width="20px;">付款方式</th>
             <th width="20px;">开票</th>
             <th width="20px;">提货地址</th>
             <th width="20px;">单据状态</th>
             <th width="20px;">录入人</th>    
             <th width="20px;">商品编号</th>
             <th width="20px;">商品名称</th>
             <th width="20px;">价格</th>
             <th width="20px;">数量</th>
             ...
             <th width="20px;">单据状态</th>   
             <th width="20px;">系统单号</th>
             <th width="20px;">是否导出</th>
             <th width="20px;">最后一次导出时间</th>
