...
<body>
 ...
 collapse;width:651pt" width="866">
            <colgroup>
                <col style="mso-width-source:userset;mso-width-alt:3104;width:73pt" width="97" />
            ...
            <tr style="mso-height-source:userset;">
                <td class="auto-style21">销售中心：</td>
                <td class="auto-style13">
                    <asp:TextBox ID="cen" runat="server" CssClass="input normal" BackColor="#DDFFFF" BorderStyle="Double" Width="95%" ></asp:TextBox>
                </td>
                <td class="auto-style21">部（店）：</td>
                <td class="auto-style13">
                    <asp:TextBox ID="dept" runat="server" CssClass="input normal" BackColor="#DDFFFF" BorderColor="#00CCFF" BorderStyle="Double" BorderWidth="1px" Width="95%" ></asp:TextBox>
                </td>
                <td class="auto-style12">业务员：</td>
                <td class="auto-style13">
            ...
            <tr height="26" style="mso-height-source:userset;height:20.1pt">
                ...
                <td class="auto-style14">
                    <asp:TextBox ID="saler_tel" runat="server" CssClass="input normal" BackColor="#DDFFFF" BorderColor="#00CCFF" BorderStyle="Double" BorderWidth="1px" Width="95%" ></asp:TextBox>
                </td>
                <td class="auto-style19">下单日期：</td>
                <td class="auto-style14">
            ...
            <tr style="mso-height-source:userset;">
                ...
                <td class="auto-style21">客户联系人：</td>
                <td class="auto-style30">
            ...
            <tr height="26" style="mso-height-source:userset;height:20.1pt">
                ...
                <td class="auto-style3">
                    <asp:TextBox ID="plucode" runat="server" CssClass="input normal" BackColor="#DDFFFF" BorderColor="#00CCFF" BorderStyle="Double" BorderWidth="1px" Width="95%" Enabled="False" ></asp:TextBox>
                </td>
                <td class="auto-style19">商品名称：<asp:TextBox ID="TextBox1" runat="server" OnTextChanged="TextBox1_TextChanged1" Width="50px"></asp:TextBox>
                </td>
                <td class="auto-style3">
            ...
            <tr style="mso-height-source:userset;">
             ...
             <tr height="26" style="mso-height-source:userset;height:20.1pt">
                ...
                <td class="auto-style16">
                    <asp:Button ID="Button3" runat="server" Height="30px" Text="修改订单" Width="98%" CssClass="auto-style17" Visible="False" />
                    　</td>
