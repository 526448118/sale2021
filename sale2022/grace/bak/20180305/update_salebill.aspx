            ...
            <tr style="mso-height-source:userset;">
             ...
             <tr style="mso-height-source:userset;">
                ...
                <td class="auto-style30" colspan="5">
                    <asp:TextBox ID="memo" runat="server" CssClass="input normal" BackColor="#DDFFFF" BorderColor="#00CCFF" BorderStyle="Double" BorderWidth="1px" Width="98%" Height="68px" TextMode="MultiLine" OnTextChanged="memo_TextChanged" ></asp:TextBox>
                    <br />
                 </td>
            </tr>
            <tr  height="26" style="mso-height-source:userset;height:20.1pt">
