<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ord_xg_list.aspx.cs" Inherits="depotmanager_order_list" %>
...
<ItemTemplate>
        <tr>
            ...
            <td><%#GetOrderStatus(Convert.ToInt32(Eval("bill_status")))%></td>
             <td><a href="../grace/add_saleord_l2.aspx?id=<%#Eval("num")%>&cx=99" class="tablelink"> 修改订单</a> </td>
        </tr> 		
 	   </ItemTemplate>
<FooterTemplate>
