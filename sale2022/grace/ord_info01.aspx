<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ord_info01.aspx.cs" Inherits="ord_info" %>
...
<script type="text/javascript">
    ...
    function insertmomo() {
        var mes = confirm('真的要作废吗，作废后订单将不可用！');
        if (mes == true) {
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="5" style="margin:5px auto; font-size:12px; font-family:'微软雅黑'; background:#fff;">
    ...
    <tr>
      ...
      <td class="auto-style7"><font class="auto-style17" size="3">联系电话：</font><asp:Label ID="custtel" runat="server" Text="Label" CssClass="auto-style17"></asp:Label>
         ...
         <td  class="auto-style22"><font class="auto-style17" size="3">应收金额：</font><asp:Label ID="ystotal" runat="server" CssClass="auto-style17"></asp:Label>
        </td>
    </tr>
    <tr>
    ...
    <td valign="top" class="auto-style20"><font class="auto-style17" size="3">开&nbsp; 票 否：</font><asp:Label ID="kp" runat="server" Text="Label" CssClass="auto-style17"></asp:Label>
        </td>
         <td valign="top" class="auto-style21"><font class="auto-style17" size="3">实收金额：</font><asp:Label ID="sstotal" runat="server" CssClass="auto-style17"></asp:Label>
        </td>
    </tr>
    <tr>
      <td valign="top" colspan="3"><font size="3">客户税码：</font><strong><asp:Label ID="sm" runat="server" Text="Label" CssClass="auto-style17"></asp:Label>
          <font class="auto-style17" size="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </font>
          </strong><font class="auto-style17" size="3">客户类型：</font><asp:Label ID="htcustom" runat="server" Text="Label" CssClass="auto-style17"></asp:Label>
          <strong>
          <br class="auto-style17" />
          </strong><font size="3">备 注：</font><asp:Label ID="memo" runat="server" Text="Label" style="font-weight: 700" ></asp:Label>
          </td>
...
<!--endprint-->
   ...
   <div id="divBtnPrint" >&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
        ...
        <asp:Button ID="Button1" runat="server" Text="打印标记" CssClass="btn"  OnClick="Button1_Click" Visible="False"   />
                 &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              <asp:Button ID="btnSubmit" runat="server" Text="审  核" CssClass="btn" OnClick="btnSubmit_Click"   />
    
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <asp:Button ID="btnSubmit0" runat="server" Text="作  废" CssClass="btn yellow" OnClientClick="insertmomo();"  OnClick="btnSubmit0_Click"   />
       	<div id="light" class="white_content"> 
	请填写作废原因！<br />
	<input  type="text" id ="zf_memo"/>
	<asp:Button  id="Button3" Text="确认提交" runat="server"  CssClass="btn yellow" OnClientClick="trans();"/> 
	<asp:Button  id="Button4" Text="取消"     runat="server"  CssClass="btn yellow" OnClientClick="close_window();"/> 
	</div>
