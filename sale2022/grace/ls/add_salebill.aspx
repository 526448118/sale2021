...
<body>
    ...
    <li><a href="product_add.aspx" class="selected">增加发票申请单</a></li>
        <li>在此输入订单号<asp:TextBox ID="TextBox1" runat="server" BorderWidth="1px"></asp:TextBox>
        </li> 
 ...
 collapse;" width="866">
            ...
            <tr>
                <td class="auto-style32" height="26">商品名称：<asp:TextBox ID="pluname0" runat="server" BackColor="#00FF99" BorderColor="#660033" BorderStyle="Double" BorderWidth="1px" Height="24px"  AutoPostBack ="True" Width="54px" OnTextChanged="pluname0_TextChanged" Visible="False"></asp:TextBox>
                </td>
                <td class="auto-style38">
