...
<asp:DropDownList ID="ordstatus"  runat="server" CssClass="normal" >
    ...
    <asp:ListItem Value="9">申请作废</asp:ListItem>
     ...
     <dd>客户名称：<span class="single-select"><asp:TextBox ID="custname" runat="server" Width="120" CssClass="scinput"></asp:TextBox></span></label>&nbsp;</dd>
        <dd>业务员：<span class="single-select"><asp:TextBox ID="ywy" runat="server" Width="120" CssClass="scinput"></asp:TextBox>下单门店（部门）：<asp:TextBox ID="xdorg" runat="server" Width="120" CssClass="scinput"></asp:TextBox></span></label>&nbsp;</dd>
