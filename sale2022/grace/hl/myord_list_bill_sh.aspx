...
<body>
    ...
    <div class="rightinfo">
                ...
                单据状态：<asp:DropDownList ID="DropDownList1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Fuchsia" Height="25px" Width="100px">
                ...
                单据来源：<asp:DropDownList ID="DropDownList2" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Fuchsia" Height="25px" Width="100px">
