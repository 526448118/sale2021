...
<body>
 ...
 collapse;width:651pt; height: 614px;">
            ...
            <tr height="26" style="mso-height-source:userset;height:20.1pt">
                ...
                <td class="auto-style41">
                    <asp:TextBox ID="price" runat="server" CssClass="input normal" BackColor="#DDFFFF" BorderColor="#00CCFF" BorderStyle="Double" BorderWidth="1px" Width="95%" AutoPostBack="True" OnTextChanged="price_TextChanged" >0</asp:TextBox>
                </td>
