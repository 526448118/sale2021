<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_saleord_l2.aspx.cs" Inherits="AjaxEngine.Demo.add_saleord_l2" %>
...
<body>
    ...
    <div class="itab">
    <ul><li>模板订单号：</li>
       <asp:TextBox ID="TextBox1" runat="server" CssClass="input normal" BackColor="#DDFFFF" BorderColor="#00CCFF" BorderStyle="Double" BorderWidth="1px" Width="154px" AutoPostBack="True"   OnTextChanged="m_TextChanged" ></asp:TextBox>
