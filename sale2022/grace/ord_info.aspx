...
<script type="text/javascript">
    ...
    function checkPrint() {
        var yxsh = document.getElementById("yxsh").innerHTML;

        if (yxsh != null && yxsh != "") { // "",null,undefined,NaN
            doPrint();
        }
        else {
            alert("营销中心未审核，不能打印！");
...
<asp:Literal ID="Literal1" runat="server"></asp:Literal>
  ...
  <td class="auto-style14"><font class="auto-style17" size="3">中&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 心：</font><asp:Label ID="cen" runat="server" Text="Label" CssClass="auto-style17"></asp:Label>
    ...
    <font class="auto-style15" size="3">
            ...
            <br />
        <asp:Label ID="kp0" runat="server" Text="Label" CssClass="auto-style17" Font-Bold="True" Font-Size="Large"></asp:Label>
            </font>
        </td>
</tr>
...
<tr>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="5" style="margin:5px auto; font-size:12px; font-family:'微软雅黑'; background:#fff;">
    <tr>
      ...
      <td class="auto-style24"><font class="auto-style17" size="3"><strong>联&nbsp; 系 人：</strong></font><asp:Label ID="custbody" runat="server" Text="Label" CssClass="auto-style17"></asp:Label>
          <br class="auto-style17" /></td>
         <td valign="top" class="auto-style27"><font class="auto-style17" size="3"><strong>付款方式：</strong></font><asp:Label ID="fktype" runat="server" CssClass="auto-style17" /><font class="auto-style17" size="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </font> </td>
    </tr>
    ...
    <tr>
      ...
      <td class="auto-style25"><font class="auto-style17" size="3"><strong>联系电话：</strong></font><asp:Label ID="custtel" runat="server" Text="Label" CssClass="auto-style17"></asp:Label>
        </td>
    ...
    <td valign="top" class="auto-style26"><font class="auto-style17" size="3"><strong>折后金额：</strong></font><asp:Label ID="sstotal" runat="server" CssClass="auto-style17"></asp:Label>
        <font class="auto-style17" size="3"><strong>实收金额：</strong></font><asp:Label ID="ss" runat="server" CssClass="auto-style17"></asp:Label>
        </td>
         <td valign="top" class="auto-style21"><font class="auto-style17" size="3"><strong>开&nbsp; 票 否：</strong></font><asp:Label ID="kp" runat="server" Text="Label" CssClass="auto-style17" Font-Bold="True" Font-Size="Medium"></asp:Label>
        </td>
    </tr>
    ...
    <td valign="top" class="auto-style26"><font class="auto-style17" size="3"><strong>客户类型：</strong></font><asp:Label ID="htcustom" runat="server" Text="Label" CssClass="auto-style17"></asp:Label>
        </td>
         <td valign="top" class="auto-style21">
             <asp:Label ID="Label5" runat="server" style="font-size: medium; font-weight: 700" Text="追加单："></asp:Label>
...
<tr>
      <td valign="top" class="auto-style23">
          <font class="auto-style17" size="3"><strong>是否远程充值:</strong></font><asp:Label ID="is_yccz" runat="server" style="font-weight: 700"  ></asp:Label>
      </td>
    <td valign="top" class="auto-style26"><font class="auto-style17" size="3"><strong>开始卡号：<asp:Label ID="ksid" runat="server" CssClass="auto-style17"></asp:Label>
        </strong></font>
        </td>
         <td valign="top" class="auto-style21">
             <asp:Label ID="Label3" runat="server" style="font-size: medium; font-weight: 700" Text="结束卡号："></asp:Label>
             &nbsp;<asp:Label ID="jsid" runat="server" style="font-weight: 700; font-size: small"></asp:Label>
        </td>
    </tr>

<tr>
      <td valign="top" class="auto-style19" colspan="3">
          <strong>断号备注：<asp:Label ID="dhmemo" runat="server"></asp:Label>
          </strong>
        </td>
    </tr>
...
<!--endprint-->
   ...
   <div id="divBtnPrint" >&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
        <input id="BtnPrint" type="button"  value="打 印" class="btn yellow" onclick="checkPrint();" />
