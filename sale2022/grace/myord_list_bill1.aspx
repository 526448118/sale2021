<%@ Page Language="C#" AutoEventWireup="true" CodeFile="myord_list_bill1.aspx.cs" Inherits="depotmanager_order_list" %>
...
<body>
    ...
    <div class="rightinfo">
        <dl class="seachform">
            <dd>
                <label>
                单据号：<span class="single-select"><asp:TextBox ID="bgndate0" runat="server" Width="120" CssClass="scinput" onclick="WdatePicker()"></asp:TextBox>
                </span>开始日期：</label><span class="single-select"><asp:TextBox ID="bgndate" runat="server" Width="120" CssClass="scinput" onclick="WdatePicker()"></asp:TextBox>
                     结束日期：<asp:TextBox ID="enddate" runat="server" Width="120" CssClass="scinput" onclick="WdatePicker()"></asp:TextBox>
                </span></dd>
            <dd>客户名称：<asp:TextBox ID="custname" runat="server" Width="120" CssClass="scinput"></asp:TextBox>&nbsp;</dd>
        <dd>业务员：<span class="single-select"><asp:TextBox ID="ywy" runat="server" Width="120" CssClass="scinput"></asp:TextBox>&nbsp;</dd>
