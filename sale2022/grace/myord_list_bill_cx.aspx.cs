...
public partial class depotmanager_order_list : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
         ...
         {
             sqljc = " and sale_source like '%" + dd_type + "%' and billtype like '%" + fp_type + "%' and status = '99' order by num desc";
    ...
    private void Export(String FileType, String FileName)
    {
       string custname = this.ordbillno.Text.Trim();
        ...
        if (role =="7")
        {
            ...
            {
                HiddenField hideid = (HiddenField)rptList.Items[i].FindControl("HiddenField1");
                string b = hideid.Value.ToString();
                string dcsql = "update ord_receipt set is_dc = '1' where num in (select num from ord_receipt_view001 where xd_billno = '" + b + "')";
                cc.execSQL01(dcsql);
            }
