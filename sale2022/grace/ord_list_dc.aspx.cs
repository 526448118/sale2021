...
public partial class depotmanager_order_list : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (bgndate != "" && enddate != "")
        {
            if (ordstatus == "99")
            {
                sqljc = " and num like '%" + billno + "%' and lrdate between '" + bgndate + "' and '" + enddate + "' and custname like '%" + custname + "%' and saler like '%" + ywy + "%' and bill_status like '%" + ordstatus + "%' order by bill_status";
            }
            else
            {
                sqljc = " and num like '%" + billno + "%' and lrdate between '" + bgndate + "' and '" + enddate + "' and custname like '%" + custname + "%' and saler like '%" + ywy + "%' and isdc like '%" + ordstatus + "%' order by bill_status";
            }
        }
        else
        {
