<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ord_list_cx.aspx.cs" Inherits="depotmanager_order_list" %>
...
<body>
   ...
   <label>   
        订单状态：
    <span >
<asp:DropDownList ID="ordstatus" class="easyui-combobox" runat="server" Width="110px">
    ...
    <asp:ListItem Value="已打印">已打印</asp:ListItem>
    <asp:ListItem Value="未打印">未打印</asp:ListItem>
</asp:DropDownList>
    </span>
        订单号：</label><span class="single-select"><asp:TextBox ID="billno" runat="server" Width="120" CssClass="scinput"></asp:TextBox>
      下单时间：<asp:TextBox ID="bgndate" runat="server" Width="120" CssClass="scinput" onclick="WdatePicker()" Height="32px"></asp:TextBox>
              到<asp:TextBox ID="enddate" runat="server" Width="120px" CssClass="scinput" onclick="WdatePicker()" Height="32px"></asp:TextBox>
    </span>
	<br/>
      客户名称：<span class="single-select"><asp:TextBox ID="custname" runat="server" Width="120" CssClass="scinput"></asp:TextBox></span>
        业务员：<span class="single-select"><asp:TextBox ID="ywy" runat="server" Width="120" CssClass="scinput"></asp:TextBox>下单门店（部门）：<asp:TextBox ID="xdorg" runat="server" Width="120" CssClass="scinput"></asp:TextBox></span>
                <asp:Button ID="lbtnSearch" runat="server" CssClass="scbtn" onclick="btnSearch_Click" Text="查询"></asp:Button>   
                <asp:LinkButton ID="btnExport" runat="server" CssClass="save" OnClick="Button1_Click">  <span><img src="../images/t04.png" /></span>导出Execl</asp:LinkButton>
