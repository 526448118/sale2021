<%@ Page Language="C#" AutoEventWireup="true" CodeFile="myord_list_bill_xg.aspx.cs" Inherits="depotmanager_order_list" %>
...
<body>
    ...
    <div class="rightinfo">
        <dl class="seachform">
         <dd>
                <label>开始日期：</label><span class="single-select"><asp:TextBox ID="bgndate" runat="server" Width="120" CssClass="scinput" onclick="WdatePicker()" OnTextChanged="bgndate_TextChanged"></asp:TextBox>
  ...
  <dd><asp:LinkButton ID="btnExport" runat="server" CssClass="save" OnClick="Button1_Click" Visible="False">   <li><span><img src="../images/t04.png" /></span>导出Execl</li></asp:LinkButton></dd>
...
<HeaderTemplate>
	  <table  class="tablelist"  >
        ...
        <th width="30px;" align="left">单据状态</th>
...
<ItemTemplate>
 ...
 <td ><asp:Label ID="no" runat="server" Text="Label"></asp:Label></td>
        <td>     <a href="../grace/update_salebill.aspx?id=<%#Eval("num")%>&cx=99" class="tablelink">修改</a> </td>
 <td><%# Eval("num")%></td>
