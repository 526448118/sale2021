...
public partial class depotmanager_order_list : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        cxsql = "select * from ord_receipt_view001 where COM ='" + com + "' and jobno='" + jobno + "'and lrtime between '" + bgndate + "' and '" + enddate + "' and status = '99'";
    ...
    private void Export(String FileType, String FileName)
    {
        ...
        if (com == "成都")
        {
            string sql = "select * from ord_receipt_view001 where com='" + com + "' and "
   + " jobno='" + jobno + "'";  // 
