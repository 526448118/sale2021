<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gy_info.aspx.cs" Inherits="grace_Default" %>
...
<body style="height: 452px; text-align: center">
 ...
 collapse;width:651pt; height: 113px;">
            <colgroup>
            ...
            <tr style="mso-height-source:userset;">
                <td class="auto-style1" colspan="6">雇员信息录入 &nbsp;</td>
            </tr>
            <tr style="mso-height-source:userset;">
                <td class="auto-style43">雇员编码</td>
            ...
            <tr style="mso-height-source:userset;">
                <td class="auto-style18">
                    <asp:TextBox ID="orgcode" runat="server" CssClass="input normal" BackColor="#DDFFFF" BorderStyle="Double" Width="90%" ></asp:TextBox>
                </td>
                <td class="auto-style40">
                    <asp:TextBox ID="orgname" runat="server" CssClass="input normal" BackColor="#DDFFFF" BorderStyle="Double" Width="90%" ></asp:TextBox>
                </td>
                <td class="auto-style32">
                    <asp:TextBox ID="bgdate" runat="server" CssClass="input normal" BackColor="#DDFFFF" BorderStyle="Double" Width="90%" ></asp:TextBox>
                </td>
                <td class="auto-style40">
            ...
            <tr style="mso-height-source:userset;">
                ...
                <td class="auto-style40">
                    &nbsp;</td>
                <td class="auto-style14">
                   <a href ="uploadfiles/gy/模板.xlsx">模板下载<style="text-decoration: underline; width: 50px; color: #FF66FF"/></a></td>
                <td class="auto-style47">
            ...
            <tr style="mso-height-source:userset;">
                <td class="auto-style18">
                     雇员搜索</td>
                <td class="auto-style40">
                    <asp:TextBox ID="orgname0" runat="server" CssClass="input normal" BackColor="#DDFFFF" BorderStyle="Double" Width="90%" ></asp:TextBox>
                </td>
                <td class="auto-style32">
    ...
    <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="orgcode"             HeaderText="雇员编码"/>
                            <asp:BoundField DataField="orgname"             HeaderText="雇员名"/>
                            <asp:BoundField DataField="bgdate"              HeaderText="开始时间"/>
                            <asp:BoundField DataField="endate"              HeaderText="结束时间"/>                          
                            <asp:BoundField DataField="gxtime"              HeaderText="更新时间"/>
                            <asp:BoundField DataField="memo"                HeaderText="备注"/>   
                            <asp:TemplateField HeaderText ="编辑">
                                <ItemTemplate>
                                    <asp:LinkButton ID="ButtonEdit" runat="server" Text ="编辑" OnClick="btnDown_Click" CommandArgument='<%# Bind("orgcode") %>'></asp:LinkButton>
                                </ItemTemplate>   
                              </asp:TemplateField>                                                         
                        </Columns>
