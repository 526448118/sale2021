...
<body>
    ...
    <li><a href="#">实物订单</a></li>
        <li><strong><em>&nbsp;</em></strong><a href="ord_list_zfsq_cx.aspx" class="auto-style1"><strong><em>实物订单查询</em></strong></a></li>
    </ul>
    </div>  
    <div class="rightinfo">
    <dl class="seachform"> 
  ...
  <div id="PageContent" runat="server" class="default"> <li>
         <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
		                ...
		                <ItemStyle HorizontalAlign="Center" />
                            ...
                            <asp:BoundField DataField="kp"           HeaderText="开票"/>
                            ...
                            <asp:BoundField DataField="custnamecode"             HeaderText="客户编码"/>   
                            <asp:BoundField DataField="addcode"             HeaderText="提货地址编码"/>                                                      
                        </Columns>
