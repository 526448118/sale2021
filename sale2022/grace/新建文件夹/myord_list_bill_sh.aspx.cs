...
public partial class depotmanager_order_list : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (source == "---请选择---")
        {
            sql1 = "select distinct * from ord_receipt_view001 where cen = '" + center + "' and COM ='" + com + "'and custom like '%" + custname + "%' and dept like '%" + ywy + "%'";
        }
        else if (source != "---请选择---")
        {
            sql1 = "select distinct * from ord_receipt_view001 where cen = '" + center + "' and  COM ='" + com + "'and custom like '%" + custname + "%' and dept like '%" + ywy + "%' and sale_source = '" + source + "'";
        }
        ...
        contrlRepeater(sql1 +sqljc+ cxsql);
