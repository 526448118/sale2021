  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="5" style="margin:5px auto; font-size:12px; font-family:'微软雅黑'; background:#fff;">
    ...
    <td valign="top" class="auto-style26"><font class="auto-style17" size="3"><strong>折后金额：</strong></font><asp:Label ID="sstotal" runat="server" CssClass="auto-style17"></asp:Label>
        <font class="auto-style17" size="3"><strong>实收金额：</strong></font><asp:Label ID="ss" runat="server" CssClass="auto-style17"></asp:Label>
         ...
         <td valign="top" class="auto-style21"><font class="auto-style17" size="3"><strong>开&nbsp; 票 否：</strong></font><asp:Label ID="kp" runat="server" Text="Label" CssClass="auto-style17"></asp:Label>
        </td>
    </tr>
    ...
    <td valign="top" class="auto-style26"><font class="auto-style17" size="3"><strong>客户类型：</strong></font><asp:Label ID="htcustom" runat="server" Text="Label" CssClass="auto-style17"></asp:Label>
         ...
         <td valign="top" class="auto-style21">
             <asp:Label ID="Label5" runat="server" style="font-size: medium; font-weight: 700" Text="是否已回款："></asp:Label>
...
<!--endprint-->
   ...
   <div id="divBtnPrint" >&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
        <input id="btnprint" runat="server" type="button"  value="打 印" class="btn yellow" onclick="checkPrint();" />
