<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ord_list_sw_cx.aspx.cs" Inherits="depotmanager_order_list" %>
...
<body>
    ...
    <li><a href="#">实物订单</a></li>
        <li><strong><em>&nbsp;</em></strong><a href="ord_list_zfsq_cx.aspx" class="auto-style1"><strong><em>作废记录查询</em></strong></a></li>
    </ul>
    </div>  
    <div class="rightinfo">
    <dl class="seachform"> 
...
<asp:DropDownList ID="ordstatus"  runat="server" >
    ...
    <asp:ListItem>已导出</asp:ListItem>
        ...
        提货时间</span>：<asp:TextBox ID="bgndate" runat="server" Width="120" CssClass="scinput" onclick="WdatePicker()"></asp:TextBox>至<asp:TextBox ID="enddate" runat="server" Width="120" CssClass="scinput" onclick="WdatePicker()"></asp:TextBox>
          
        申请时间：<asp:TextBox ID="bgndate0" runat="server" Width="120" CssClass="scinput" onclick="WdatePicker()"></asp:TextBox>至<asp:TextBox ID="enddate0" runat="server" Width="120" CssClass="scinput" onclick="WdatePicker()"></asp:TextBox></dd>
	

        <dd>客户名称：<span class="single-select"><asp:TextBox ID="custname" runat="server" Width="120" CssClass="scinput"></asp:TextBox></span></dd>
        <dd>下单门店：<span class="single-select"><asp:TextBox ID="ywy" runat="server" Width="120" CssClass="scinput"></asp:TextBox></span></dd>     
        <dd><asp:Button ID="lbtnSearch" runat="server" CssClass="scbtn" onclick="btnSearch_Click" Text="查询"></asp:Button></dd>
        <dd><asp:LinkButton ID="btnExport" runat="server" CssClass="save" OnClick="dc_Click">   <li><span><img src="../images/t04.png" /></span>导出Execl</li></asp:LinkButton></dd>
  ...
  <div id="PageContent" runat="server" class="default"> <li>
         <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                        CellPadding="3" Font-Size="9pt"  BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"   Height="149px" Width="1489px" OnRowDataBound="GridView1_RowDataBound" HorizontalAlign="Center">
