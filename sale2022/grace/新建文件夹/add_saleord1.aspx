<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add_saleord1.aspx.cs" Inherits="_add_saleord" %>
...
<body>
    ...
    <div class="itab">
  	<ul> 
    <li><a href="product_add.aspx" class="selected">增加订单</a>&nbsp;&nbsp;输入模板订单号：</li>
        <li>&nbsp;<asp:TextBox ID="TextBox1" runat="server" OnTextChanged="mb_TextChanged"></asp:TextBox>
        </li>
