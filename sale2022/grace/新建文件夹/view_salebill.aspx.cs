...
public partial class _add_saleord : System.Web.UI.Page
{
        ...
        //Response.Write(ty);
          if (!IsPostBack)
          {
              ...
              if (ty == "2")
              {
                  ...
                  {
                      this.shenhe.Visible = this.shenhe1.Visible = this.Button1.Visible = false;
                  }
                  else if (a == 7 && b == 2)
                  {
                  ...
                  {
                      this.shenhe.Visible = this.shenhe1.Visible = this.Label1.Visible = this.Label2.Visible = this.Button1.Visible = false;
              ...
              else if (ty == "1")
              {
                  ...
                  {
                      this.shenhe.Visible = this.shenhe1.Visible = this.Label3.Visible = this.Label2.Visible = this.Button1.Visible = false;
                      this.Label1.Visible = true;
                  }
                  else if (b == 3)
                  {
                      this.shenhe.Visible = this.shenhe1.Visible = this.Label3.Visible = this.Label1.Visible = this.Button1.Visible = false;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
            ...
            string status = "99";//作废
            string sql1 = "update ord_receipt set status = '99' where num = '" + billno + "' ";
    ...
    protected void shenhe_Click(object sender, EventArgs e)
    {
        ...
        string sql1 = "update ord_receipt set status = '02' where num = '" + billno + "' ";
        string sql2 = "insert into ord_receipt_status(billno,lrr,gxtime,status) values ('" + billno + "','" + jobno + "','" + gxtime + "','" + status + "')";
        SqlConnection myConn = cc.Getconsql02();
        myConn.Open();
    ...
    protected void shenhe1_Click(object sender, EventArgs e)
    {
        ...
        string sql1 = "update ord_receipt set status = '03' where num = '" + billno + "' ";
        string sql2 = "insert into ord_receipt_status(billno,lrr,gxtime,status) values ('" + billno + "','" + jobno + "','" + gxtime + "','" + status + "')";
        SqlConnection myConn = cc.Getconsql02();
        myConn.Open();
        ps_manager myuser = new ps_manager();
