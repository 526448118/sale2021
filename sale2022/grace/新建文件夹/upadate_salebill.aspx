...
<body>
 ...
 collapse;" width="866">
            ...
            <tr style="mso-height-source:userset;">
                <td class="auto-style1" colspan="6" width="866">发票申请资料录入</td>
            </tr>
            <tr style="mso-height-source:userset;">
                ...
                <td class="auto-style39">
                    <asp:TextBox ID="dept" runat="server" CssClass="input normal" BackColor="#DDFFFF" BorderColor="#00CCFF" BorderStyle="Double" BorderWidth="1px" Width="92%" ReadOnly="True" ></asp:TextBox>
                </td>
    ...
    <div>
        <br>
    <hr>
        <asp:GridView ID="GridView1" CssClass="GridViewStyle" runat="server" Font-Size="Small" style="z-index: 1; left: 10px; top: 378px; height: 115px; width: 800px;" UseAccessibleHeader="False" Width="800px" BorderColor="#660066" BorderStyle="Dotted" BorderWidth="1px">
