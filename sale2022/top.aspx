...
<head runat="server">
       <meta http-equiv="refresh"content="60;url=top.aspx"/> 
    <title>头部</title>
...
<body style="background:url(images/topbg.gif) repeat-x;">
    ...
    <ul class="nav">
    <li><a href="sysmanager/notice_list.aspx" target="rightFrame" class="selected"><img src="images/ico01.png" title="系统首页"  width="45" height="45"/><h2>系统首页</h2></a></li>
    <li><a href="order/goods_list.aspx--" target="rightFrame"><img src="images/8.png" title="中秋专案" width="45" height="45"/><h2>商品信息</h2></a></li>
    <li><a href="grace/myord_list.aspx"  target="rightFrame"><img src="images/1.png" title="我的订单" width="45" height="45"/><h2>我的订单</h2></a></li>
