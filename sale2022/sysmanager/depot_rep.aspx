<%@ Page Language="C#" AutoEventWireup="true" CodeFile="depot_rep.aspx.cs" Inherits="sysmanager_depot_rep" %>
    ...
    <form id="form1" runat="server">
	  <table width="98%"  border="1" align="center" cellpadding="5" cellspacing="1" bgcolor="#CACACA">
          <tr bgcolor="#EAEAEA">
            ...
            <span style="font-size:18px;line-height: 25px;"><b>公司信息表</b></span></td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td align="center"  bgcolor="#C0C0C0"><b>序号</b></td>
            <td align="center"  bgcolor="#C0C0C0"><b>所属公司</b></td>
            <td align="center"  bgcolor="#C0C0C0"><b>部门名称</b></td>
