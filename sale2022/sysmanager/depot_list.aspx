<%@ Page Language="C#" AutoEventWireup="true" CodeFile="depot_list.aspx.cs" Inherits="sysmanager_depot_list" %>
...
<body>
    ...
    <div class="tools">  
    	<ul class="toolbar">
        <a href="depot_edit.aspx?action=Add"><li><span><img src="../images/t01.png" /></span>添加</li></a>
